...
#' includes built in checks for argument formation and funtion arguments.
#'
...
#'
#' @param ... Agruments passed to \code{\link[base]{mapply}}.
...
#' the result of applying the functionargument to each element of the
