...
#' character string given a path name to a file.
#' 
#' @param x Character. String of the file name. Can be absolute or relative
#' path, or just the basename.
#' @return A string containing the extension of the file name passed in `x`.
#' @author Stu Field
#' @seealso \code{\link{regexpr}}, \code{\link{basename}}
#' @examples
#' getFileExt("file.pdf")
